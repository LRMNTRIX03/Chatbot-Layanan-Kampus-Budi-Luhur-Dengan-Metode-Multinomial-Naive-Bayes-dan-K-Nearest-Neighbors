...
import useIntents from "../../../hooks/useIntent";

export default function PatternIndex() {
  const { patterns, loading, removePattern, createFromFilePattern } = usePattern();
...
// Filter data
const filteredPatterns = filterIntent
  ? patterns.filter((item) => item.intent_id == filterIntent)
  : patterns;
  ...
  return (
    <div className="content-container p-6">
      ...
      <div className="flex flex-wrap justify-between items-center mb-6 gap-3">
        <h1 className="text-2xl font-bold text-gray-800">Daftar Pattern</h1>
        <div className="flex gap-3 flex-col">
        
          <FormUpload onSubmit={createFromFilePattern} label="Upload Pattern File" />
            <Link
            to="create"
        ...
        <table className="min-w-full border border-gray-300 rounded-lg overflow-hidden shadow-sm">
          <thead className="bg-gray-800 text-white text-left">
            <tr>
              ...
              <th className="py-3 px-4 border-b border-gray-300">Text Pattern</th>
          ...
          <tbody className="text-gray-700">
            ...
            {currentPatterns.map((item, index) => {
              ...
              const textToShow = isExpanded ? item.text : truncateText(item.text, 50);
                ...
                <tr className="hover:bg-gray-50 transition" key={item.id}>
                  ...
                  <td className="py-3 px-4 border-b border-gray-300">
                    <div className="flex flex-col">
                      <span className="text-gray-800 break-words">{textToShow}</span>
